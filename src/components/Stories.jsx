  ...
  return <>
    ...
    {open && <div className="fixed inset-0 z-50 bg-black grid place-items-center" onClick={()=>setOpen(null)}>
      <div className="relative w-full h-full max-w-[480px] mx-auto">
        ...
        <div className="absolute top-0 inset-x-0 p-3"><div className="h-1 bg-white/30 rounded"><div className="h-full w-full bg-white rounded animate-[shrink_5s_linear]"/></div></div>
